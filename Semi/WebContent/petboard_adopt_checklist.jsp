		...
		<div class="container d-flex justify-content-center">
			<div class="col-9">
				<div class="card">
    					...
    					<div class="check_start" style="margin-left: 20%;"><!-- 체크 항목 시작 -->
			    			<form>
							  <div class="mb-3">
							    ...
							    <div class="col-sm-9">
							    <input type="text" class="form-control" id="friendname" name="q1"></div>
							  </div>
							  <div class="mb-3">
							    <label for="age" class="form-label">2. 통화하기 편한 시간</label>
							    <div class="col-sm-9">
							    <input type="text" class="form-control" id="call" name="q2"></div>
							  </div>
							  <div class="mb-3">
							    <label for="adr" class="form-label">3. 거주지</label>
							    <div class="col-sm-9">
							    <input type="text" class="form-control" id="adr" placeholder="(예: 서울, 경기, 강원... 등)" name="q3"></div>
							  </div>
							  <div class="mb-3">
							    <label for="marriage" class="form-label" >4. 결혼 여부</label>
							    <div class="col-sm-9">
							    <div class="form-check">
							    	<input class="form-check-input" type="radio" name="q4_marriage" id="marriage">
									...
									<div class="form-check">
									  <input class="form-check-input" type="radio" name="q4_marriage" id="marriage" checked>
									  <label class="form-check-label" for="marriage">
									    기혼
									  </label>
							   		</div>
								...
								<div class="mb-3">
								    ...
								    <div class="col-sm-9">
								    <input type="text" class="form-control" id="job" name="q5"></div>
								</div>
								  <div class="mb-3">
								  	...
								  	<div class="col-sm-9">
									<textarea rows="3" class="form-control form-control-md rounded-0" name="q6"></textarea></div>
								  </div>
								  	<div class="mb-3">
								  	...
								  	<div class="col-sm-9">
									<textarea rows="3" class="form-control form-control-md rounded-0" name="q7"></textarea></div>
								  </div>
								  <div class="mb-3">
								  	<label for="live" class="form-label">8. 현재 거주하고 계신 주택 형태와 가족 구성원은 어떻게 되나요?</label>
								  	<div class="col-sm-9">
									<textarea rows="3" class="form-control form-control-md rounded-0" name="q8"></textarea></div>
								  </div>
								  <div class="mb-3">
								  	<label for="why" class="form-label">9. 입양을 원하시는 이유는 무엇인가요?</label>
								  	<div class="col-sm-9">
									<textarea rows="3" class="form-control form-control-md rounded-0" name="q9"></textarea></div>
								  </div>
								  <div class="mb-3">
							    <label for="baby" class="form-label">10. 만약 댁에서 새로운 아기가 출생할 경우 입양된 동물을 계속 키우실 수 있나요?</label>
							    <div class="col-sm-9">
							    <div class="form-check">
							    	<input class="form-check-input" type="radio" name="q10_babyradio" id="babyradio">
									...
									<div class="form-check">
									  <input class="form-check-input" type="radio" name="q10_babyradio" id="babyradio" checked>
									  <label class="form-check-label" for="babyradio">
									    아니오
									  </label>
							   		</div>
							   	...
							   	<div class="mb-3">
								  	...
								  	<div class="col-sm-9">
									<textarea rows="3" class="form-control form-control-md rounded-0" name="q11"></textarea></div>
								  </div>
    				...
    				<input type="button" class="btn btn-primary" value="제출하기" onclick="location.href='checklist.do?command=insert'"/>
    				</div>
    		</div>
    	</div>
    </div>
